...
Use select instead of drop

use `__name__ ==__main__` 

call package directly is different from call using other script as base script

date format



standard structure of a project
...
- 
- for date variables, always use datetime from datetime
- no hardcode value: anytime when you use hardcode values they should be stored as a variable at the begining of the script, unless it is 0,1,-1,-2 that indicate the position
- When selecting columns from dataframe, try your best to select by column name instead of column position index. 
- dont import unused packages or functions
- at the begining of your scripts, list external and internal imports separately
- the structure of your program should be like  this 

- - Helpers.py
  - ReadData.py
  - Other scripts...
  - ...
  - A main.py that integrates all operations and functions.
